...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div>
        <section className="bg-white dark:bg-gray-900 rounded-xl font-raleway mb-20">
            ...
            <div className="mr-auto place-self-center lg:col-span-7">
              ...
              <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                <span className="font-semibold">
                  Deploy multiple LLMs in storage space of 1
                </span>
                , Using our custom training & fine-tuning capabilities you can
                acheive upto 90% reduction in the size without compromising on
                performance
              </p>
              <a
                href="#faq-section"
        ...
        <section className="bg-white dark:bg-gray-900 mb-20 font-raleway rounded-xl">
          <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div className="max-w-screen-md mb-8 lg:mb-16">
              <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                Designed for businesses of all sizes across all areas
              </h2>
              <p className="text-gray-500 sm:text-xl dark:text-gray-400 tracking-normal">
                We here at <span className="font-extrabold">Pankh.Ai</span>{" "}
                believe that a rising tide raises all boats, whether big or
                small, almost all businesses will benefit from incorporating
                Artificial Intelligence into their workflows, to boost
                productivity and promote overall economic growth.
              </p>
            </div>
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Whether your company needs to compose creative marketing
                  emails or schedule engaging campaigns for customer growth, our
                  fine-tuned LLMs can assist your team to craft those with a
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  You can conduct a secure analysis of your private legal data,
                  and have our custom LLM analyze your executive decisions
                  discreetly and not have to worry about compliance once oue LLM
                  is finely tuned on your data.
                </p>
              </div>
              <div>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  At Pankh.Ai, your data is your own and we respect your
                  privacy. We don&apos;t store any of our customer&apos;s data &
                  we don&apos;t access our LLMs after they are customised to
                  your needs.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Get a custom LLM privately trained on your financial data and
                  unlock the potential worthy of rivaling the best Chartered
                  Accountants of the world
                </p>
              </div>
              <div>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Gone are the days of searching through all your files to find
                  a key piece of information, You can deploy a custom LLM that
                  is trained upon your uploaded documents and will answer
                  anything related to those.
                </p>
              </div>
              <div>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  With us, you have complete control over the level of Privacy,
                  Guardrails, Data-Sharing, Encryption so that your business is
                  safe and so we mind our business
                </p>
              </div>
            </div>
          </div>
        </section>
        <section className="bg-white dark:bg-gray-900 mb-20 font-raleway rounded-xl" id="faq-section">
          <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800 mb-20 font-raleway rounded-xl">
          <div className="mx-auto max-w-screen-xl">
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                <a href="https://flowbite.com" className="flex items-center">
                  <Image
                    src="/images/featherbgr.png"
                    width={40}
                    height={20}
                    //className="mr-3 h-8 w-10"
                    alt="PankhAI Logo"
                  />
